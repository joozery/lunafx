...
const en: Dictionary = {
  ...
  forgotPassword: {
    metaTitle: "Forgot Password | Lunaforex",
    metaDescription: "Reset your Lunaforex account password.",
    heading: "Forgot Password",
    subheading: "Enter your email and we'll send a 6-digit OTP to reset your password.",
    emailLabel: "Email Address",
    emailPlaceholder: "you@example.com",
    sendOtp: "Send OTP",
    sending: "Sending...",
    otpSentMessage: "A 6-digit OTP has been sent to your email. It expires in 15 minutes.",
    otpLabel: "OTP Code",
    ...
    successSubMessage: "You can now login with your new password.",
  },
  legal: {
    label: "Legal",
